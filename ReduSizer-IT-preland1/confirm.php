...
<head>
    ...
    <title>Un sacco di v grazie!</title>
    ...
    <style>
        ...
        *>* {
        ...
        .orderDetails-item {
            ...
            padding-top: 70px;
            margin-bottom: 70px;
            background: linear-gradient(180deg, #b72c95 0%, #8a2771 100%);
            /* border-radius: 30px; */
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <section class="header-container">
            <h1>Un sacco di v grazie!</h1>
            <h2>Il vostro ordine è stato accettato!</h2>
            <ul class="orderDetails">
                <li class="orderDetails-item"><span>Il nostro specialista vi contatterà per confermare l'ordine.</span></li>
                <li class="orderDetails-item"><span>La consegna avviene tramite corriere a domicilio.</span></li>
                <li class="orderDetails-item"><span>L'operatore spiega tutti i dettagli.</span></li>
                <li class="orderDetails-item"><span>Pagamento al ricevimento.</span></li>
            </ul>
