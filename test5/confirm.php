        ...
        *>* {
        ...
        .orderDetails-item {
          flex-basis: 176px;
              ...
              padding-top: 70px;
              margin-bottom: 70px;
              background: linear-gradient(180deg, #2b2929 0%, #2b2929 100%);
              /* border-radius: 30px; */
...
<body>
    ...
    <div class="main-wrapper">
      ...
      <section class="header-container">
        <h1>Mulțumim!</h1>
        <h2>Comanda dumneavoastră este acceptata!</h2>
        <ul class="orderDetails">
          <li class="orderDetails-item">
            <span>Specialistul nostru vă va suna pentru a confirma comanda</span>
          </li>
          <li class="orderDetails-item">
            <span>Operatorul va clarifica toate detaliile necesare</span>
          </li>
          <li class="orderDetails-item">
            <span>Livrarea se face prin curier in ambalaje netransparente anonime</span>
          </li>
          <li class="orderDetails-item">
            <span>Plata se face la primirea marfii</span>
          </li>
        </ul>
      </section>
