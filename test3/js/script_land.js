    ...
    function runScriptsParams(land_params) {
        if (typeof(jQuery) === 'undefined') {
            if (!jQ) {
                ...
                _scr.src = "jquery.min.js"/*tpa=https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js*/;
                ...
                $(function() {
                        ...
                        $.ajax({
                            ...
                            success: function (response){
                                if(response.status == 'ok'){
                                    var url = 'http://tr-recardio.exclusive-goods.org/success.html';
                    ...
                    if ( fb_pixel_land ){
                        !function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?
                            ...
                            document,'script','fbevents.js'/*tpa=http://connect.facebook.net/en_US/fbevents.js*/);
